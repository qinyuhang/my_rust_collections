...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1__h4d7dffa8243b28b1: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hde17177d3fbd1f0b: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hf65c74e1067a85ea: (a: number, b: number) => void;
